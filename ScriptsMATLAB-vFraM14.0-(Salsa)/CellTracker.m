...
% CELLTRACKER M-file for CellTracker.fig
...
%      applied to the GUI before CellTracker_OpeningFunction gets called.  An
...
% Last Modified by GUIDE v2.5 20-Feb-2005 23:36:17
...
set(handles.edit5, 'String', sprintf('%s_analysis.txt', strtok(get(handles.edit1, 'String'), '.')));
set(handles.edit6, 'String', sprintf('%s_summary.txt', strtok(get(handles.edit1, 'String'), '.')));
set(handles.edit7, 'String', sprintf('%s_msd.txt', strtok(get(handles.edit1, 'String'), '.')));
...
% handles    structure with handles and user data (see GUIDATA)
handles = guidata(gcf);
TrackerRead(get(handles.edit1, 'String'), ...
    ...
    str2double(get(handles.edit9, 'String')));   % ADDED FRANCESCO MARANGONI 1/17/2011
...
set(hObject, 'String', 'input_analysis.txt');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
strtemp = strcat('''', strrep(get(handles.edit5, 'String'), ',', ''','''), '''');
sprintf('GraphAnalysis(%d,%d,%s);',str2num(get(handles.edit9,'String')), str2num(get(handles.edit2,'String')), strtemp)
eval(sprintf('GraphAnalysis(%d,%d,%s);',str2num(get(handles.edit9,'String')), str2num(get(handles.edit2,'String')), strtemp));
...
set(hObject, 'String', 'input_summary.txt');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
strtemp = strcat('''', strrep(get(handles.edit6, 'String'), ',', ''','''), '''');
eval(sprintf('GraphSummary(%s);', strtemp));
...
set(hObject, 'String', 'input_msd.txt');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
strtemp = strcat('''', strrep(get(handles.edit7, 'String'), ',', ''','''), '''');
eval(sprintf('GraphMSD(%s);', strtemp));
